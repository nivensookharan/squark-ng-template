...
- **Tailwind CSS Templates & Patterns**: Copy-ready layout, form, card, and badge patterns using Tailwind v4 with CSS custom properties. Read [tailwind-template.md](references/tailwind-template.md)
...
When setting up or consuming module federation in Angular, consult the following reference:

- **Native Federation Templates**: Full setup guide and copy-ready config for remote and host applications using `@angular-architects/native-federation` (esbuild, Angular 17+). Read [native-federation-template.md](references/native-federation-template.md)
